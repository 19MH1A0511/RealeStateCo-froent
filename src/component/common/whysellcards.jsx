...
function WhyChooseUsCards() {
  const cards = [
    {
      icon: <FaDollarSign className="text-blue-500 text-3xl sm:text-4xl" />,
      title: "Best Market Prices",
      description:
        "We offer competitive pricing backed by real-time market analytics to maximize your property’s value.",
    },
    {
      icon: <FaHandshake className="text-blue-500 text-3xl sm:text-4xl" />,
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl  font-bold text-gray-900 mb-8 sm:mb-12 max-w-xl mx-auto text-center leading-snug">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
        {cards.map(({ icon, title, description }, idx) => (
          <div
            key={idx}
            className="bg-white rounded-2xl p-5 sm:p-6 shadow-md transition-all duration-300 flex flex-col items-center text-center cursor-pointer
                       hover:shadow-2xl sm:hover:scale-105 hover:border-blue-400 hover:bg-blue-50"
          >
