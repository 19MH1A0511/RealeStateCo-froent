...
export default function PropertyCard() {
  ...
  return (
    <div
      ...
      <div className="bg-gradient-to-r from-gray-100 to-white rounded-3xl shadow-xl p-5 sm:p-6 md:p-8 w-full max-w-5xl flex flex-col md:flex-row justify-between gap-6 md:gap-10 lg:gap-12">
